                ...
                <tbody>
                    <c:forEach items="${articles}" var="article">
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                <a href="editarticle.ars?id=${article.id}&idArtisan=${sessionScope.artisan.id}" class="text-blue-500 hover:text-blue-700 mr-2">Edit</a>
                                <a href="deletearticle.ars?id=${article.id}&idArtisan=${sessionScope.artisan.id}" class="text-red-500 hover:text-red-700">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
